...
//
//        Video video1 = new Video(Long.parseLong("1"), "Teste 1", "Video api teste", "www.teste.com", new Category());
//        Video video2 = new Video(Long.parseLong("2"), "Teste 2", "Video api teste 2", "www.teste2.com", new Category());
//
...
//
//        Optional<Video> video = Optional.of(new Video(Long.parseLong("1"), "Teste 2", "Video api teste 2", "www.teste2.com", new Category()));
//
//        VideoServiceImpl service = Mockito.mock(VideoServiceImpl.class);
//        when(service.findVideoById(1L)).thenReturn(video);
//
